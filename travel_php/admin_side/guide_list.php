    ...
    <div class="container">
        ...
        <div class="table-main">
           <div class="search">
                ...
                <input type="search" name="search" placeholder="Id or first name">
                <!-- <a href="#"><img src="search.png"></a> -->
                <button type="submit" name="submit" class="search_btn"><img src="search.png" alt=""></button>
            
        </div>
        <table>
            
            <?php 
            include('g_tables.php');
                ?>
